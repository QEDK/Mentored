...
- Backend: If you're working on implementing a feature in the backend, the commit should begin with `backend: 'Brief Description'`
- Frontend: If you're working on the frontend, your commit should begin with `frontend: 'Brief Description'`
