            ...
            <Container fluid='md' style={{overflow:'hidden', width:'95vw'}}>
                <Row>
                    <Col xs={12} md={8} lg={6}>
                        ...
                        <p style={{fontSize:'22px'}} className='mt-2' style={{color:'#0B173D'}}>Mentored provides you <span style={{color:'#DAA520'}}>curated paths and guidance</span> from professionals in the fields of front-end and back-end web dev, devops, data science and many more....</p>
